...
function getBasketElementHeaderHtmlTemplate(product, basketAmmount = 1) {
  ...
  const BasketHeaderContainer = createHtmlElementWithClass(
    "div",
    "basket-entry__header"
  );

  const basketEntryTitle = createHtmlElementWithClass(
    "h3",
    "basket-entry__title noselect"
  );
  ...
  BasketHeaderContainer.append(deleteEntryButton);
  }
...
const basketFooterContainer = createHtmlElementWithClass(
  ...
  deleteEntryButton.classList.add("clickable","noselect","basket-entry__delete-btn" );
  deleteEntryButton.dataset.action = "delete-entry";
  basketFooterAmmountControl.append(deleteEntryButton);
  }
  else{
  ...
  basketFooterAmmountControl.append(decreaseEntryAmmountButton);
  }
  ...
  basketFooterAmmountControl.append(
    entryAmmount,
